...
| Category | Voxel Proxy | Count |
|---|---|---|
| None (0) | 0 voxels | — |
| Mild (1) | 1–49 voxels | — |
| Moderate (2) | 50–199 voxels | — |
| Severe (3) | ≥200 voxels | — |
...
| Model | Time | 
|---|---|
| **U-Net (ours)** | **11.97 ms/slice** |
| TotalSegmentator (`--fast`) | 37,800 ms/scan (~37.8s) |
| **Speedup** | **~3,157× faster per slice** |

The U-Net is dramatically faster than TotalSegmentator while achieving a median Dice of 0.94 against TotalSegmentator's own masks as ground truth. This demonstrates the core goal: a lightweight model that approximates TotalSegmentator quality at a fraction of the inference cost.
